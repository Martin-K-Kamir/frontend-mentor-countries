...
const SearchCountry = ({
    ...
    const classes = classnames(
        " flex items-center relative sm:max-w-md w-full bg-white dark:bg-shark-900 py-3 px-5 sm:py-4 sm:px-6 gap-4 rounded-lg shadow text-base cursor-text transition-opacity",
        {
